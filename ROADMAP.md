...
- **[x] Operasi String:** Membangun fungsi bawaan untuk manipulasi string (misalnya, penggabungan, pemotongan). Fungsi `akar` telah diganti dengan `kekecil` untuk manipulasi string.
